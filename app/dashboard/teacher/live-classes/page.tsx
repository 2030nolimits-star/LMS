...
const demoLiveClasses = [
  ...
  { id: "2", title: "Linear Transformations", courseName: "Linear Algebra", status: "scheduled", scheduledAt: new Date(Date.now() + 86400000).toISOString(), duration: 60, attendees: 0 },
  { id: "3", title: "Intro to Trees", courseName: "Data Structures & Algorithms", status: "ended", scheduledAt: new Date(Date.now() - 400000000).toISOString(), duration: 75, attendees: 38 },
]
        ...
        <div className="flex shrink-0 border-t border-white/5 pt-3 md:border-t-0 md:pt-0">
          {isLive ? (
            ...
            <div className="flex gap-2 w-full md:w-auto">
              ...
              <Button size="sm" className="flex-1 md:w-auto bg-primary text-primary-foreground shadow-[0_0_15px_rgba(168,85,247,0.4)] hover:bg-primary/90">
                 Start Now
              </Button>
            </div>
          )}
