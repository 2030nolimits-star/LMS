          ...
          <div className="flex-1 flex flex-col">
             {activeConversation ? (
                      ...
                      return (
                        <div key={msg.id} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                          <div className={`max-w-[70%] flex flex-col gap-1 ${isMe ? 'items-end' : 'items-start'}`}>
                            <div className={`px-4 py-3 rounded-2xl ${isMe ? 'bg-primary text-primary-foreground rounded-tr-sm shadow-lg shadow-primary/20' : 'bg-white/10 text-foreground rounded-tl-sm border border-white/5'}`}>
                              {msg.content}
                            </div>
               ...
               <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
                 ...
                 <p className="text-sm text-muted-foreground mt-1 max-w-xs">Choose a contact from the sidebar to start messaging your professors or peers.</p>
               </div>
             )}
          </div>
