                ...
                >
                  <div className="relative">
                    <div className={cn(
                      ...
                      conv.other.role === "teacher" ? "bg-primary/20 text-primary" : "bg-white/10 text-muted-foreground"
                    )}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={cn("text-xs truncate", conv.unreadCount > 0 ? "text-primary font-medium" : "text-muted-foreground")}>
                      {conv.lastMessage}
                    </p>
                  </div>
                </div>
