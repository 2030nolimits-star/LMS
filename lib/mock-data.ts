...
export const users: User[] = [
  ...
  },
  {
    ...
    registrationNumber: "STU-2025-009",
    role: "student",
    avatar: "IT",
    enrolledCourses: ["c1", "c2"],
    department: "Mathematics",
  ...
  },
  {
    ...
    registrationNumber: "STU-2025-010",
    role: "student",
    avatar: "JR",
  ...
  },
  {
    id: "u11",
    name: "Kelly White",
    email: "kelly@university.edu",
    registrationNumber: "STU-2025-011",
    role: "student",
    avatar: "KW",
    enrolledCourses: ["c4", "c1"],
    department: "Computer Science",
    joinedAt: "2026-01-20",
    status: "active",
  },
  {
    ...
    registrationNumber: "STU-2025-012",
    role: "student",
    avatar: "LG",
    enrolledCourses: ["c5", "c2"],
    department: "Mathematics",
    joinedAt: "2026-01-22",
    status: "active",
  },
  {
    ...
    registrationNumber: "STU-2025-013",
    role: "student",
    avatar: "MB",
    enrolledCourses: ["c4", "c3"],
    department: "Computer Science",
    joinedAt: "2026-01-25",
    status: "active",
  },
  {
    ...
    registrationNumber: "STU-2025-014",
    role: "student",
    avatar: "NM",
    enrolledCourses: ["c5", "c1"],
  ...
  },
  {
    ...
    registrationNumber: "STU-2025-015",
    role: "student",
    avatar: "OD",
    enrolledCourses: ["c4", "c2"],
    department: "Computer Science",
    joinedAt: "2026-02-01",
    status: "active",
  },
  {
    ...
    name: "Het Pandya",
    email: "het@edura.edu",
    registrationNumber: "STU-2026-999",
    role: "student",
    avatar: "HP",
...
export const courses: Course[] = [
  ...
  },
  {
    ...
    code: "CS402",
    description: "Building responsive, modern web applications using Next.js, React, and Tailwind CSS.",
    teacherId: "t1",
    teacherName: "Dr. Sarah Thompson",
    students: ["u1", "u2", "u3", "u5", "u7"],
    color: "hsl(199, 89%, 48%)",
    semester: "Spring 2026",
    credits: 4,
    materials: [
      { id: "m11", courseId: "c4", title: "Introduction to React Hooks", type: "pdf", uploadedAt: "2026-02-15", size: "1.5 MB" },
      { id: "m12", courseId: "c4", title: "Server-side Rendering vs Static Generation", type: "slide", uploadedAt: "2026-02-18", size: "2.8 MB" },
    ],
    assignments: [
      {
        id: "a7",
        ...
        description: "Create a responsive portfolio website using Next.js and Tailwind.",
        dueDate: "2026-06-20",
        maxScore: 100,
        submissions: [],
      },
  ...
  },
  {
    ...
    teacherId: "t1",
    teacherName: "Dr. Sarah Thompson",
    students: ["u1", "u4", "u5", "u7"],
    color: "hsl(280, 75%, 60%)",
    semester: "Spring 2026",
    credits: 4,
    materials: [
      { id: "m13", courseId: "c5", title: "Heuristic Search Strategies", type: "pdf", uploadedAt: "2026-02-10", size: "3.2 MB" },
      { id: "m14", courseId: "c5", title: "Neural Networks Overview", type: "video", uploadedAt: "2026-02-14", size: "210 MB" },
    ],
    assignments: [
      {
        id: "a8",
        courseId: "c5",
        title: "Assignment 1: A* Search Implementation",
        description: "Implement the A* algorithm to solve a sliding puzzle.",
        dueDate: "2026-06-15",
        maxScore: 100,
        submissions: [],
      },
...
export const liveClasses: LiveClass[] = [
  {
    ...
    title: "Functions & Scope - Live Coding Session",
    scheduledAt: "2026-02-17T10:00:00",
    duration: 60,
    status: "ended",
    teacherId: "t1",
    teacherName: "Dr. Sarah Thompson",
    attendees: ["u1", "u2", "u3", "u5"],
    description: "We will cover Python functions, scope rules, and closures with live coding examples.",
  },
  {
    id: "lc2",
    courseId: "c2",
    courseName: "Calculus II",
    title: "Series Convergence Tests Review",
    ...
    teacherName: "Prof. James Brown",
    attendees: [],
    description: "Review session for all convergence tests before the midterm.",
  },
  {
    id: "lc3",
    courseId: "c3",
    courseName: "Digital Logic Design",
    title: "Karnaugh Maps Workshop",
    ...
    teacherName: "Dr. Sarah Thompson",
    attendees: [],
    description: "Hands-on workshop for simplifying Boolean expressions using K-maps.",
  },
  {
    id: "lc4",
    courseId: "c1",
    ...
    teacherName: "Dr. Sarah Thompson",
    attendees: [],
    description: "Comprehensive review covering all topics from weeks 1-5.",
  },
  {
    id: "lc5",
    courseId: "c1",
    ...
    description: "Covered recursive algorithms and their applications.",
  },
  {
    id: "lc6",
    courseId: "c4",
    ...
    teacherName: "Dr. Sarah Thompson",
    attendees: ["u1", "u2", "u3", "u5"],
    description: "In-depth look at Compound Components, Render Props, and Higher-Order Components.",
  },
  {
    id: "lc7",
    courseId: "c5",
  ...
  },
  {
    ...
    teacherName: "Dr. Sarah Thompson",
    attendees: [],
    description: "Learn how to manage server state efficiently using React Query.",
  },
  {
    id: "lc9",
    courseId: "c1",
    ...
    teacherName: "Dr. Sarah Thompson",
    attendees: ["u1", "u5", "u6"],
    description: "Live session on common data structures like Stacks, Queues, and Linked Lists.",
  },
]
